...
castle:
	python3 generate.py castle.ldr castle_wall_constraints brick castle_brick_defs tile close

augcastle:
	python3 ldr2gmr.py examples/castle-human.ldr grammars/castle_aug_init.gmr
	python3 generate.py augcastle.ldr castle_aug_init brick tile castle_brick_defs close

rock:
	python3 generate.py rock.ldr sheer_rock
